...
import LandEE from "../assets/multi3.jpg"
import LandWW from "../assets/multi4.jpg"
...
const Ecommerce = () => {
    ...
    return (
        <section className="bg-[black] lg:py-[70px] py-[30px] pb-[46px] lg:pb-0">
            <div className="container px-3 lg:px-0 mx-auto">
                <div className="lg:w-[80%] w-full bg-[#262626] lg:py-[50px] py-[30px] lg:rounded-[50px] rounded-[20px] mt-[100px] lg:mt-0">
                    <h3 className="font-Poppins font-bold lg:text-[48px] text-[30px] text-[#FFCC2E] text-center lg:pb-[50px] py-[30px]">E-Commerce Project</h3>
