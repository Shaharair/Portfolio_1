...
import LandEE from "../assets/multi5.jpg"
import LandWW from "../assets/multi6.jpg"
import LandXX from "../assets/multi7.jpg"
...
const PersonalPortfolio = () => {
    ...
    return (
        <section className="bg-[black] lg:py-[60px] py-[30px] pb-[105px] lg:pb-0">
            <div className="container px-3 lg:px-0 mx-auto">
                <div className="lg:w-[80%] w-full bg-[#262626] lg:py-[50px] py-[30px] lg:rounded-[50px] rounded-[20px] mt-[100px] lg:mt-0">
                    ...
                    <div className="">
                        <Slider {...settings}>
                            <div className="">
                                <img className="lg:mx-[330px] rounded-[20px]" src={LandEE} alt="multi" />
                            </div>
                            <div className="">
                                <img className="lg:mx-[330px] rounded-[20px]" src={LandWW} alt="multi1" />
                            </div>
                            <div className="">
                                <img className="lg:mx-[330px] rounded-[20px]" src={LandXX} alt="multi2" />
                            </div>
                        </Slider>
                    </div>
                </div>
